...
//button.addEventListener('click', showConsole, {"once": false,});
//button.addEventListener('mouseenter', showConsole, {"once": false,});
//AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA_________________________________
/*

Спливання та занурення

let block = document.querySelector('.block');
let blockInner = document.querySelector('.block__inner');
let blockInnerInner = document.querySelector('.block__inner-inner');

block.addEventListener('click', function(){ console.log('Клік на БЛОК 1')}, );
blockInner.addEventListener('click', function(){ console.log('Клік на БЛОК 2')}, );
blockInnerInner.addEventListener('click', function(){ console.log('Клік на БЛОК 3')}, );
*/
...
// Використано 4 обробника, хоча можна використати 1 (один на 4 об'єкта).
/*
...
//AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA_________________________________
//ДОМАШКА
/*
1. Изучить теорию
2. Решить задачу:
